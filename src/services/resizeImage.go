...
// need to handle multiple concurrent rezies
// need to not block other photo resize
// need to use less memory when rezising
// need to be lightweight and fast, average time for resize is about 6secs, need shorter time
